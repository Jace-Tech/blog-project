			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <form class="forms-sample" action="../../../handlers/admin_handler.php" method="post" >
                      <div class="mb-3">
                      ...
                      <div class="form-check mb-3">
                        <input type="checkbox" class="form-check-input" name="remember_me" value="true" id="authCheck">
